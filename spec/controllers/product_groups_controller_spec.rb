...
#   # ProductGroupsController. Be sure to keep this updated too.
#   let(:valid_session) { {} }
#
...
#         post :create, params: {product_group: valid_attributes}, session: valid_session
#         expect(response).to redirect_to(ProductGroup.last)
#       end
#     end
#
#     context "with invalid params" do
#       it "returns a success response (i.e. to display the 'new' template)" do
#         post :create, params: {product_group: invalid_attributes}, session: valid_session
#         expect(response).to be_success
#       end
#     end
#   end
...
#         product_group = ProductGroup.create! valid_attributes
#         put :update, params: {id: product_group.to_param, product_group: new_attributes}, session: valid_session
...
#         expect(response).to redirect_to(product_group)
#       end
#     end
#
#     context "with invalid params" do
...
#         product_group = ProductGroup.create! valid_attributes
#         put :update, params: {id: product_group.to_param, product_group: invalid_attributes}, session: valid_session
#         expect(response).to be_success
#       end
#     end
#   end
